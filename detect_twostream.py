...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/mnt/cd/ljx/xiaofuwuqi/runs/train/exp225/weights/best.pt', help='model.pt path(s)')
